...
var Language_list_full_name = [
    "日本語", 
    "English"
];    // This is the language possible
var Language_list_shorten_name = [ 
    "ja", 
    "en"
];

var Language_accepts = [
    "続ける",
    "CONTINUE"
];
...
function Selecting_type_of_user( Lang_index ) {
    ...
    for ( var i = 0; i < 3; i++ ) {
        ...
        User_link_element.setAttribute( "href", "/" + Language_list_shorten_name[ Lang_index ] + "/user" + i);
